const CACHE='foundation-inspector-pro-v1';
const CORE=['./','./index.html','./manifest.webmanifest','../-ORD-Caisson-Inspector/caisson-plan.png','../-ORD-Caisson-Inspector/index.html'];
